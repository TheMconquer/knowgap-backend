...
#         # Get quiz submission
#         json_payload = {
#             "query": "query MyQuery($course_id: ID!, $user_id: ID!, ) {" \
#                 "course(id: $course_id) {" \
#                     "assignmentsConnection(filter: {userId: $user_id}) {" \
#                     "nodes {" \
#                         "_id," \
#                         "submissionsConnection(filter: {userId: $user_id}, first: 1) {" \
#                         "nodes {" \
#                             "_id," \
#                             "score" \
#                         "}" \
...
#                 if "errors" in data:
#                     logger.error(f"Canvas' GraphQL API call returned an error: {data['errors']}")
#                     return {
...
#                 submissions = data.get("data", {}).get("course", {}).get("assignmentsConnection", {}).get("nodes", [])
#                 if not submissions:
#                     return {
...
#                     if (entry.get("quiz") or {}).get("_id") == quiz_id:
#                         submission = x
